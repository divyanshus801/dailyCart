...
export default function Cartscreen() {
    ...
    const userLogin = loginUserReducer.currentUser;
            ...
            <div className="row justify-content-center p-2" data-aos='fade-down'>
                  ...
                  <div className="col-md-6">
                       ...
                       {cartItems.map(item=>{
                           ...
                           <div className='m-1 w-100'>
                           <i className="fa fa-trash mt-5" cursor="pointer" aria-hidden="true" onClick={()=>{dispatch(deleteFromCart(item))}}></i>
                           </div>
                  ...
                  <div className="col-md-4 text-right">
                      ...
                      { !userLogin == "" ?
                           ...
                           (<Link className="m-1 w-100" to="/login">
                           <button className="btn" >Login To Checkout</button>
                       </Link>)
                      }
